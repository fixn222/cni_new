...
function DestinationCard({
  ...
  return (
    <ScrollReveal>
      <Card className="w-full p-0 max-w-sm h-auto bouncy-hover max-w-sm rounded-2xl backdrop-blur-2xl shadow-2xl cursor-pointer ">
        ...
        <CardDescription className="p-3">
          <div className="inline-flex justify-between w-full ">
            ...
            <span className="mx-1  text-gray-600">
              <Star className="text-secondary fill-secondary" /> {rating}
            </span>
          </div>
          ...
          <Link
            href={imageUrl}
            className="inline-flex items-center gap-x-1 bouncy-link mt-3 mb-3 font-bold text-primary"
          >
